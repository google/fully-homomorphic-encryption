...
(* top =  1  *)
(* src = "blaze-out/k8-fastbuild/bin/third_party/fully_homomorphic_encryption/transpiler/examples/ifte/ifte_yosys.v:1.1-8.10" *)
module ifte(i, t, e, out);
  (* src = "blaze-out/k8-fastbuild/bin/third_party/fully_homomorphic_encryption/transpiler/examples/ifte/ifte_yosys.v:4.20-4.21" *)
  input [7:0] e;
  (* src = "blaze-out/k8-fastbuild/bin/third_party/fully_homomorphic_encryption/transpiler/examples/ifte/ifte_yosys.v:2.14-2.15" *)
  input i;
  (* src = "blaze-out/k8-fastbuild/bin/third_party/fully_homomorphic_encryption/transpiler/examples/ifte/ifte_yosys.v:5.21-5.24" *)
  output [7:0] out;
  (* src = "blaze-out/k8-fastbuild/bin/third_party/fully_homomorphic_encryption/transpiler/examples/ifte/ifte_yosys.v:3.20-3.21" *)
  input [7:0] t;
  imux2 _0_ (
    .A(t[0]),
    .B(e[0]),
