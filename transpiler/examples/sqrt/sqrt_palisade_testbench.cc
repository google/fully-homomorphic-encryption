...
#include "transpiler/examples/sqrt/sqrt_interpreted_palisade.h"
#else
#include "transpiler/examples/sqrt/sqrt_palisade.h"
#endif

constexpr auto kSecurityLevel = lbcrypto::MEDIUM;

PalisadeShort FHESqrt(PalisadeShort& ciphertext, lbcrypto::BinFHEContext cc) {
...
int main(int argc, char** argv) {
  ...
  // Encode data
  auto ciphertext = PalisadeShort::Encrypt(input, cc, sk);
  ...
  PalisadeShort result = FHESqrt(ciphertext, cc);
