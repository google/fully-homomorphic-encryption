#ifndef TRANSPILER_EXAMPLES_STRUCTS_ARRAY_OF_ARRAY_OF_STRUCTS_H_
#define TRANSPILER_EXAMPLES_STRUCTS_ARRAY_OF_ARRAY_OF_STRUCTS_H_
...
#endif  // TRANSPILER_EXAMPLES_STRUCTS_ARRAY_OF_ARRAY_OF_STRUCTS_H_
