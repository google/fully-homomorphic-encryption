#ifndef TRANSPILER_EXAMPLES_STRUCTS_STRUCT_WITH_STRUCT_ARRAY_H_
#define TRANSPILER_EXAMPLES_STRUCTS_STRUCT_WITH_STRUCT_ARRAY_H_
...
#endif  // TRANSPILER_EXAMPLES_STRUCTS_STRUCT_WITH_STRUCT_ARRAY_H_
