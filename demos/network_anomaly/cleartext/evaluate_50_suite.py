"""Batched cleartext evaluation and validation suite runner for 50-feature PyTorch KitNET."""
...
from demos.network_anomaly.torch import pytorch_50_kitnet

PyTorch50KitNET = pytorch_50_kitnet.PyTorch50KitNET
resolve_path = path_utils.resolve_path


def load_50_dataset_suite(
    data_file: str, num_samples: int, num_features: int = 50
) -> torch.Tensor:
  """Loads up to num_samples packet feature vectors from 50-feature binary dataset."""
...
def evaluate_50_suite(
  ...
  """Evaluates 50-feature PyTorch KitNET model over dataset suite."""
  resolved_model_path = resolve_path(model_path)
  resolved_data_path = resolve_path(data_file)

  print("=" * 80)
  print("  PyTorch 50-Feature KitNET Evaluation & Ground Truth Validation")
  print("=" * 80)
  ...
  data_tensor = load_50_dataset_suite(data_file, num_samples, num_features)
  ...
  print("\n" + "=" * 80)
  print("  50-Feature Reconstruction Loss & Anomaly Detection Summary")
  print("=" * 80)
...
def main():
  parser = argparse.ArgumentParser(
      description="Evaluate 50-feature PyTorch KitNET over dataset."
  )
  parser.add_argument(
      "--num_samples",
      type=int,
